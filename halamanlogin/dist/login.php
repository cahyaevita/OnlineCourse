...
<body>
  ...
  <body>
    <div class="session">
      ...
      <form action="../../config/autentikasi.php" method="post" class="log-in" autocomplete="off">
        <h4>We are <span>MAJESTIC ONLINE COURSE</span></h4>
        <p>Welcome back! Log in to your account to view today's clients:</p>
        <div class="floating-label">
          <input placeholder="Username" type="Username" name="Username" id="Username" autocomplete="off">
