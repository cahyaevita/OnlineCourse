...
$id = isset($_POST["id_material"]) ? intval($_POST["id_material"]) : null; // Untuk update
...
if (isset($_POST['tambah'])) {
    ...
    $stmt->bind_param('issss', $course_id, $title, $description, $embed_link); // Pastikan tipe data sesuai
